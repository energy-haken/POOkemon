...
public class Utilisateur extends Joueur {
    ...
    public Utilisateur(ListePouvoirs pouvoirs) {
        super(pouvoirs);
    }
    ...
    public void inputUtiliserPouvoir2(Pokemon pokemon , Adversaire adversaire){
        while(true) {
            System.out.println("Qui va subir le pouvoir ? (1 = Vous même | 2 = Adversaire | 3 = STOP)");
            int j = Input.InputChiffre();
            if (j == 1) {
            ...
            if (j == 3) {
                System.out.println("Voulez vous utiliser le pouvoir ? (1 : Oui | 2 : Non | 3 : Description du pouvoir.") ;
                break;
            } else {
                System.out.println("Mauvaise valeur 2");
            }
        }
    }
